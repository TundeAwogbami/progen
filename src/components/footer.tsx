    ...
    <footer className="bg-gray-100 py-8">
      <div className="container px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-600">
              ProGen is dedicated to empowering schools and students through innovation and recognition.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services" className="text-sm text-gray-600 hover:text-gray-900">Our Services</Link></li>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center">
          <p className="text-sm text-gray-600">&copy; 2023 ProGen. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
